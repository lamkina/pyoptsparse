...
class Variable(object):
    ...
    def __str__(self):
        ...
        if self.type == "d":
            ...
            res += f"{self.type:25s}{self.choices[int(self.value)]:20f} {min(self.choices):14.2e} {max(self.choices):12.2e} \n"
        else:
            lower = self.lower
            upper = self.upper
            ...
            res += f"{self.type:5s} {self.value:14f} {lower:14.2e} {upper:12.2e} \n"
